...
from insteon.devices import (GroupSendHandler, GroupFunctions, Base)
...
class Root(Group):
    ...
    def create_message(self, command_name):
        ...
        the message'''
        return self.specific.create_message(command_name)
    ...
    def send_command(self, command_name, state=''):
        ...
        return self.specific.send_command(command_name, state='')
